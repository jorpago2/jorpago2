...
test("homepage has the personal academic layout and keeps the five-image carousel", async () => {
  ...
  assert.match(html, /class="simulator-links"[\s\S]*?href="https:\/\/jorpago2\.github\.io\/"[\s\S]*?href="https:\/\/jorpago2\.github\.io\/research-topic-explorer\/"[\s\S]*?href="https:\/\/jorpago2\.github\.io\/uv-administracion\/"/);
